...
import { graphConfig, apiConfig } from "../../commonApi/apiConfig";
...
console.log('heatMapData', heatMapData, sectorValue )
    ...
    const getHeatMap = async () => {
        try {
            ...
            if (startDate === getCurrentDate()) {
                url = `getContributionWithSector?exchangeSymbol=NIFTY%2050`;
            } else {
                url = `getContributionWithSector?startDate=${startDate}&exchangeSymbol=NIFTY%2050`;
            }
    ...
    setHeatMapData(Object.values(groupedData));
        ...
        const totalPoints = Object.values(groupedData).reduce((sum, card) => sum + card.totalPoints, 0);
        console.log("groupedData 3", groupedData)
        setTotalPoints(totalPoints); // Set total points for display
        setHeatMapData(Object.values(groupedData));
    ...
    return (
        ...
        <div style={{ position: 'relative' }}>
            ...
            <div className="select-container" style={{
                ...
                >
                    <MenuItem value={1}>Sector </MenuItem>
                    <MenuItem value={2}>Industry </MenuItem>
                    <MenuItem value={3}>Basic Industry </MenuItem>
                </Select>
